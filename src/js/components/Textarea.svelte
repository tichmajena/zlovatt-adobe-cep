<script>
  ...
  export let obj = { field_input: "", field_label: "" };
  export let i;
  export let ii;
...
<div class="flex flex-row relative mb-6">
  ...
  <div class="container mx-auto w-full flex flex-row lg:relative lg:z-0">
    <div class="w-1/12 flex align-center">
      <MoveIcon />
    </div>
    <div
    ...
    >
      ...
      <div class="md:flex flex flex-col-reverse w-full md:flex-row">
        <div class="bg-purple-200 p-4 md:pr-7 rounded-md md:w-3/5">
          <input
            type="text"
            tooltip
            bind:value={obj.field_label}
            class="mb-3 md:mt-0 mt-3 outline-one focus:outline-none bg-transparent p-0 text-sm border-0 focus:ring-0 ring-0 text-purple-900"
          />

          <textarea
            class=" rounded border-0 outline-none text-purple-900 text-md font-medium focus:outline-none focus:shadow-lg focus:ring focus:ring-purple-700 w-full"
        ...
        >
          <input
            ...
            class=" rounded border-0 outline-none py-1 text-sm focus:outline-none focus:shadow-md w-full focus:ring focus:ring-purple-700 bg-purple-400"
          ...
          >
            <span
              class="relative z-10 p-2 mx-auto text-xs leading-none text-purple-900 whitespace-no-wrap bg-purple-500 rounded shadow-lg"
              >Layer Name</span
            >
            <div class="w-3 h-3 -mt-2 rotate-45 bg-purple-500" />
          </div>
        </div>
      </div>
    </div>
